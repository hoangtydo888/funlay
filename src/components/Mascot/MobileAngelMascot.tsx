        ...
        >
          <video
            ...
            style={{
              ...
              filter: isExcited 
                ? 'brightness(1.4) contrast(1.8) saturate(1.5) drop-shadow(0 0 15px rgba(255, 215, 0, 0.8))' 
                : 'brightness(1.3) contrast(1.8) saturate(1.4) drop-shadow(0 0 10px rgba(255, 215, 0, 0.6))',
            }}
          >
